# Social Media and Web Analytics Lab: A/B Testing (Intro)
...
```{bash, eval = FALSE}
git clone https://github.com/course-web-analytics/lab2-ab-test.git
```

Once you have cloned the files, open the cloned repository in RStudio as an RStudio project and work through the questions in `lab-ab-test.Rmd`.
