...
## Part 1: Designing a Randomized Control Trial
...
## Part 2: Implementing an A/B test
...
Add your solutions to the `lab-ab-test.Rmd` file as you work through the exercises so that you have a record of the work you have done.
...
When you are uncertain or do not know what to do next - ask questions of your peers and the instructors on Canvas discussion board.
...
![Udacity Free Trial Screener](exp_screenshot.png)

The unit of analysis is a cookie, although if the student enrolls in the free trial, they are tracked by user-id from that point forward. 
